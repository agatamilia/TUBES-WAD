...
<!--===============================================================================================-->	
	...
	<link rel="stylesheet" href="assets/img/icogns/favicon.ico">
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="text-center p-t-46 p-b-20">
						<a href="views/index" class="txt2">
							sign up</a>
					</div>

					<div class="login100-form-social flex-c-m">
						<a href="https://m.facebook.com/login/?locale=id_ID&refsrc=deprecated" class="login100-form-social-item flex-c-m bg1 m-r-5">
